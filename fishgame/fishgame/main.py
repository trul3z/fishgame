...
class FishingGame:
    ...
    def animate_gif(self):
        ...
        try:
            # Get the directory where the script is located
            base_dir = os.path.dirname(os.path.abspath(__file__))
            image_path = os.path.join(base_dir, "koda_fishing.gif")  # Same filename as above
            ...
            if not hasattr(self, 'gif_frames'):
                ...
                while True:
                    try:
                        ...
                        # Optional: Scale the image (makes it 2x larger - adjust as needed)
                        scaled_frame = frame.zoom(10, 10)  # Makes image 2x larger
                        # Or use: scaled_frame = frame.subsample(2, 2)  # Makes image 2x smaller
            ...
            if len(self.gif_frames) > 1:
                ...
                # Schedule next frame update (adjust delay as needed - 100ms works well)
